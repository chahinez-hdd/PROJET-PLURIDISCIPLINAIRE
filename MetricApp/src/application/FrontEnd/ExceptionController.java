...
public class ExceptionController {
		...
		System.out.println(ListException);
	        ...
	        TreeItem<TreeItemData> NotDefaultException = new TreeItem<>(new TreeItemData("Not Default Exception","M 20.5 11 H 19 V 7 c 0 -1.1 -0.9 -2 -2 -2 h -4 V 3.5 C 13 2.12 11.88 1 10.5 1 S 8 2.12 8 3.5 V 5 H 4 c -1.1 0 -1.99 0.9 -1.99 2 v 3.8 H 3.5 c 1.49 0 2.7 1.21 2.7 2.7 s -1.21 2.7 -2.7 2.7 H 2 V 20 c 0 1.1 0.9 2 2 2 h 3.8 v -1.5 c 0 -1.49 1.21 -2.7 2.7 -2.7 c 1.49 0 2.7 1.21 2.7 2.7 V 22 H 17 c 1.1 0 2 -0.9 2 -2 v -4 h 1.5 c 1.38 0 2.5 -1.12 2.5 -2.5 S 21.88 11 20.5 11 Z"));
